                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="datatable-responsive"
                                ...
                                <tbody>
                                <c:forEach var="appInfo" items="${appInfoList }" varStatus="·">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="dataTables_info" id="datatable-responsive_info"
                                ...
                                ${pages.curPage }/${pages.totalPage }页
                            </div>
                        </div>
                        <div class="col-sm-7">
                                ...
                                <ul class="pagination">
                                    <c:if test="${pages.curPage > 1}">
                                        ...
                                        <li class="paginate_button "><a
                                                href="javascript:page_nav(document.forms[0],${pages.curPage-1});"
                                                aria-controls="datatable-responsive" data-dt-idx="1"
                                                tabindex="0">上一页</a>
                                        </li>
                                    </c:if>
                                    <c:if test="${pages.curPage < pages.totalPage }">
                                        <li class="paginate_button "><a
                                                href="javascript:page_nav(document.forms[0],${pages.curPage+1 });"
                                                aria-controls="datatable-responsive" data-dt-idx="1"
                                                tabindex="0">下一页</a>
